...
function TemplateNine({ resumeData, formData }) {
    ...
    return (
        <div id="resume-pdf" className="w-[794px] min-h-[1123px] bg-white p-8 text-sm leading-snug">
            <div className="grid grid-cols-[minmax(0,32%)_minmax(0,68%)] gap-3 text-sm leading-5">
                <aside className="border-r border-gray-300 pr-2 space-y-2">
                    {hasPhoto ? (
                    ...
                    <div className="text-xs">
                        ...
                        <p className="break-all">{data.personalDetails.email}</p>
                        <p className="break-all">{data.personalDetails.linkedin}</p>
                        <p className="break-all">{data.personalDetails.website}</p>
                    </div>

                    {data.skills.length > 0 ? (
                        <section className="min-w-0 space-y-1">
                            <h2 className="border-b border-gray-300 pb-0.5 text-xs font-bold uppercase tracking-wide">Skills</h2>
                ...
                <main className="min-w-0 space-y-2">
                    ...
                    {data.achievements.length > 0 ? (
                        <section className="min-w-0 space-y-1">
                            <h2 className="border-b border-gray-300 pb-0.5 text-xs font-bold uppercase tracking-wide">Achievements</h2>
                            <ul className="list-disc space-y-1 pl-4 text-sm">
