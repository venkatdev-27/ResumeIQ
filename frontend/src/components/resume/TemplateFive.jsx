...
function TemplateFive({ resumeData, formData }) {
    ...
    return (
        <div id="resume-pdf" className="w-[794px] min-h-[1123px] bg-white p-8 text-sm leading-snug">
            <div className="text-sm leading-5 break-words">
                <header className="mb-2 border-b border-gray-400 pb-1">
                ...
                {data.personalDetails.summary ? (
                    <section className="mb-2 space-y-1">
                        <h2 className="border-b border-gray-300 pb-0.5 text-xs font-bold uppercase tracking-wide">Summary</h2>
...
export default React.memo(TemplateFive);
