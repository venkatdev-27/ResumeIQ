...
function TemplateSeven({ resumeData, formData }) {
    ...
    return (
        <div id="resume-pdf" className="w-[794px] min-h-[1123px] bg-white p-8 text-sm leading-snug">
            <div className="text-sm leading-5 break-words">
                <header className="mb-2 border-b-2 border-gray-700 pb-1 text-center">
                    <h1 className="text-base font-bold tracking-[0.08em] uppercase">{data.personalDetails.fullName}</h1>
                ...
                {data.workExperience.length > 0 ? (
                    <section className="mb-2 space-y-1">
                        <h2 className="border-b border-gray-300 bg-gray-100 px-1 py-0.5 text-xs font-bold uppercase tracking-wide">Employment History</h2>
                ...
                {data.projects.length > 0 ? (
                    <section className="mb-2 space-y-1">
                        <h2 className="border-b border-gray-300 bg-gray-100 px-1 py-0.5 text-xs font-bold uppercase tracking-wide">Projects</h2>
                ...
                <section className="mb-2 grid grid-cols-2 gap-2">
                    {data.education.length > 0 ? (
                        <div className="space-y-1">
                            <h2 className="border-b border-gray-300 bg-gray-100 px-1 py-0.5 text-xs font-bold uppercase tracking-wide">Education</h2>
                    ...
                    {data.skills.length > 0 ? (
                        <div className="space-y-1">
                            <h2 className="border-b border-gray-300 bg-gray-100 px-1 py-0.5 text-xs font-bold uppercase tracking-wide">Skills</h2>
                ...
                <section className="grid grid-cols-3 gap-2">
                    ...
                    {data.achievements.length > 0 ? (
                        <div className="space-y-1">
                            <h2 className="border-b border-gray-300 bg-gray-100 px-1 py-0.5 text-xs font-bold uppercase tracking-wide">Achievements</h2>
                            <ul className="list-disc space-y-1 pl-4 text-sm">
